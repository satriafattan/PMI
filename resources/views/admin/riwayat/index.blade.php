...
@section('content')
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full text-sm">
          <thead class="bg-neutral-50 text-neutral-600">
            <tr class="text-left">
              <th data-key="nama"
                  class="sortable cursor-pointer select-none px-4 py-3 font-medium">Nama Lengkap</th>
              <th data-key="tgl"
                  class="sortable cursor-pointer select-none px-4 py-3 font-medium">Tanggal Pemesanan</th>
              ...
              <th data-key="status"
                  class="sortable cursor-pointer select-none px-4 py-3 font-medium">Status</th>
  ...
  {{-- ===== Modal: Detail (layout seragam dengan detail pemesanan) ===== --}}
  <div id="detailModal"
    ...
    <div class="relative w-full max-w-3xl rounded-3xl border border-neutral-200 bg-white shadow-xl">
      ...
      <div class="flex items-center justify-end gap-3 border-t border-neutral-100 px-6 py-4">
        <button type="button"
                class="dm-close rounded-lg bg-neutral-900 px-4 py-2 text-sm font-medium text-white hover:bg-neutral-800">
          Tutup
        </button>
      </div>
    </div>
  ...
  <script>
    ...
    function openDetail(payload) {
      try {
        ...
        dm.statusBadge.textContent = status;
        dm.statusBadge.className = 'inline-flex items-center rounded-full px-3 py-1 text-xs font-medium ' + badgeClass(
          status);
