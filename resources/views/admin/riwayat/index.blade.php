...
@section('content')
    <div id="pageRoot" class="space-y-6">
        ...
        @php
            ...
            if (!function_exists('blood_pill')) {
                ...
                {
                    return '<span class="inline-flex h-6 items-center rounded-full border border-rose-100 bg-rose-50 px-2 text-xs text-rose-700 font-semibold">' .
                        e($g) .
                        '</span>';
                }
            }
            if (!function_exists('rhesus_pill')) {
                ...
                {
                    return '<span class="inline-flex h-6 items-center rounded-full border border-slate-100 bg-slate-50 px-2 text-xs text-slate-700 font-semibold">' .
                        e($r) .
                        '</span>';
                }
            }
            if (!function_exists('product_pill')) {
                ...
                {
                    return '<span class="inline-flex h-6 items-center rounded-full border border-sky-100 bg-sky-50 px-2 text-xs text-sky-700 font-semibold">' .
                        e($p) .
                        '</span>';
                }
            }
        ...
        <form id="filterForm" method="GET" class="space-y-3">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" id="produkBtn"
                                    ...
                                    <svg class="size-4 text-neutral-500 shrink-0" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor">
                            ...
                            <div class="flex items-center justify-between pt-1">
                                ...
                                <button type="button" id="applyBtn"
                                    class="px-3 py-1.5 rounded-lg bg-blue-600 text-white text-xs sm:text-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-200">Terapkan</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            @if ($hasActiveFilter)
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    @endif
                    <button type="button" id="clearAllBtn" class="text-xs text-neutral-600 hover:underline">Bersihkan
                        semua</button>
                </div>
            @endif
    ...
    <div id="detailModal"
        ...
        <div id="detailCard"
            ...
            <div
                ...
                <div class="min-w-0">
                    <h3 id="detailModalTitle"
                        class="truncate text-lg sm:text-xl font-semibold tracking-tight text-neutral-900">Detail Pemesanan
                    </h3>
            ...
            {{-- Footer --}}
            <div
                class="sticky bottom-0 z-10 flex items-center justify-end gap-3 border-t border-neutral-100/80 bg-white/80 px-4 py-3 sm:px-6 sm:py-4 backdrop-blur">
                <button type="button"
    ...
    <script>
        ...
        function filterRows() {
            ...
            return rows.filter(o => {
                ...
                const okGol = !gol || (String(o.gol ?? o.payload?.gol_darah ?? '').toUpperCase() === gol
                    .toUpperCase());
...
`;
            ...
            cont.innerHTML = html;
            cont.querySelectorAll('button[data-page]').forEach(b => b.addEventListener('click', () => {
                page = +b.dataset.page;
                masterRender();
            }));
        }
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            pageSizeMenu.querySelectorAll('button[data-size]').forEach(item => {
                item.addEventListener('click', () => {
                    ...
                    pageSizeMenu.querySelectorAll('button[role="menuitemradio"]').forEach(b => b
                        .setAttribute('aria-checked', b === item ? 'true' : 'false'));
                    closeAll();
