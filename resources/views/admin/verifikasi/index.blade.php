                            ...
                            <div class="relative">
                                ...
                                <div id="produkMenu" role="menu" aria-labelledby="produkBtn"
                                    ...
                                    @foreach ($produkOpts as $val => $label)
                                        ...
                                        {{ $produkQ === $val ? 'bg-blue-50 text-blue-800 ring-1 ring-blue-200 cursor-default' : 'text-blue-800 hover:bg-blue-50/60' }}"
                                            data-value="{{ $val }}">
                            ...
                            <div class="relative">
                                ...
                                <div id="golMenu" role="menu" aria-labelledby="golBtn"
                                    ...
                                    @foreach ($gOpts as $val => $lab)
                                        ...
                                        {{ $golQ === $val ? 'bg-blue-50 text-blue-800 ring-1 ring-blue-200 cursor-default' : 'text-blue-800 hover:bg-blue-50/60' }}"
                                            data-value="{{ $val }}">
                            ...
                            <tr class="border-t border-neutral-100 hover:bg-neutral-50/60">
                                ...
                                <td class="px-4 py-3">
                                    <button type="button"
                                        ...
                                        <svg class="size-4 opacity-75" viewBox="0 0 24 24" fill="none"
                ...
                <div class="rounded-2xl border border-neutral-200 bg-white p-4">
                    ...
                    <div class="mt-3">
                        <button type="button"
                            ...
                            aria-label="Lihat detail pemesanan {{ $o->nama_pasien }}">
                            <svg class="size-4 opacity-75" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                    d="M2.5 12s3.5-6.5 9.5-6.5S21.5 12 21.5 12s-3.5 6.5-9.5 6.5S2.5 12 2.5 12z" />
                                <circle cx="12" cy="12" r="2.7" stroke-width="1.8"></circle>
