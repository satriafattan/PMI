...
@section('content')
  ...
  <script>
    ...
    // Format tanggal ke format pendek DD/MM/YY
    ...
    function renderTable1() {
      ...
      if (slice.length === 0) {
        tbody.innerHTML =
          '<tr><td colspan="6" class="px-4 py-8 text-center text-neutral-500">Tidak ada data tersedia</td></tr>';
      } else {
      ...
      document.getElementById('pageInfo').textContent =
        `Menampilkan ${start + 1}-${Math.min(start + size1, total)} dari ${total} data`;
      ...
      if (pages > 1) {
        for (let i = 1; i <= pages; i++) {
          ...
          btn.textContent = i;
          btn.className =
            `px-3 py-1 rounded-md text-sm ${i === page1 ? 'bg-neutral-900 text-white' : 'bg-white border border-neutral-200 text-neutral-700 hover:bg-neutral-50'}`;
    ...
    function renderTable2() {
      ...
      document.getElementById('pageInfo2').textContent =
        `Menampilkan ${start + 1}-${Math.min(start + size2, total)} dari ${total} data`;
      ...
      if (pages > 1) {
        for (let i = 1; i <= pages; i++) {
          ...
          btn.textContent = i;
          btn.className =
            `px-3 py-1 rounded-md text-sm ${i === page2 ? 'bg-neutral-900 text-white' : 'bg-white border border-neutral-200 text-neutral-700 hover:bg-neutral-50'}`;
          btn.addEventListener('click', () => {
            page2 = i;
            renderTable2();
          });
    ...
    function renderTable3() {
      ...
      document.getElementById('pageInfo3').textContent =
        `Menampilkan ${start + 1}-${Math.min(start + size3, total)} dari ${total} data`;
      ...
      if (pages > 1) {
        for (let i = 1; i <= pages; i++) {
          ...
          btn.textContent = i;
          btn.className =
            `px-3 py-1 rounded-md text-sm ${i === page3 ? 'bg-neutral-900 text-white' : 'bg-white border border-neutral-200 text-neutral-700 hover:bg-neutral-50'}`;
          btn.addEventListener('click', () => {
            page3 = i;
            renderTable3();
          });
