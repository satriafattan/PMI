...
@section('title', 'Detail Darah - Tersedia')
...
@section('content')
  ...
  <div class="space-y-4">
    <div class="space-y-1">
      <h1 class="text-2xl font-semibold md:text-3xl">Detail Darah - Tersedia</h1>
      <p class="text-sm text-neutral-500">Data stok unit darah yang tersedia</p>
    </div>
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      {{-- Export --}}
      <div class="flex items-center gap-2">
        <a href="{{ route('admin.detail-darah.tersedia.export') }}"
  ...
  <script>
    ...
    const columnMap = {
      ...
      'produk': 'komponen',
      'tgl_masuk': 'tgl_masuk',
      'tgl_kadaluwarsa': 'tgl_kadaluarsa'
    };
    ...
    function updateSortHeaders() {
      document.querySelectorAll('#tersediaTable thead th[data-sort]').forEach(th => {
