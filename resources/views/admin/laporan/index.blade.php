...
@section('content')
    <div class="space-y-6">
        ...
        {{-- ===================== Toolbar ===================== --}}
        <form id="laporanForm" method="GET" class="flex flex-col gap-3 md:flex-row md:items-stretch">
            {{-- Search --}}
            <div class="relative flex-1 min-w-0">
                ...
                <input name="q" value="{{ $filters['q'] ?? '' }}"
                    class="w-full rounded-2xl border border-neutral-200 bg-white pl-11 pr-3 py-2.5 text-sm placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-navy-200 focus:border-neutral-300"
            ...
            <div class="relative">
                ...
                <div id="filterMenu"
                    class="hidden absolute right-0 z-20 mt-2 w-[22rem] rounded-2xl border border-neutral-200 bg-white p-3 shadow-xl">
                    <div class="space-y-3 text-sm">
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <input type="date" name="start" value="{{ $filters['start'] ?? '' }}"
                                    class="mt-1 w-full rounded-xl border border-neutral-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-navy-200" />
                            </div>
                            <div>
                        ...
                        <input type="hidden" name="gol" id="golInput" value="{{ $golVal }}">
                        <input type="hidden" name="produk" id="produkInput" value="{{ $produkVal }}">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" id="statusBtn"
                                ...
                                <span id="statusLabel" class="truncate">{{ $statusLabel }}</span>
                            ...
                            <div id="statusMenu"
                                ...
                                @foreach ($statusOpts as $val => $label)
                                    <button type="button"
                                        class="status-item group w-full text-left rounded-xl px-3 py-2 text-sm transition flex items-center justify-between"
                                        data-value="{{ $val }}">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" id="golBtn"
                                ...
                                <span id="golLabel" class="truncate">{{ $golLabel }}</span>
                                <svg class="size-4 text-neutral-500 shrink-0" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                        d="M6 9l6 6 6-6" />
                        ...
                        <div class="relative">
                            ...
                            <button type="button" id="produkBtn"
                                ...
                                <span id="produkLabel" class="truncate">{{ $produkLabel }}</span>
                                <svg class="size-4 text-neutral-500 shrink-0" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                        d="M6 9l6 6 6-6" />
                        ...
                        <div class="flex items-center justify-between pt-1">
                            <button type="button" id="resetBtn" class="text-sm text-neutral-600 hover:underline">
                                Reset
                            </button>
                            <button type="submit"
                                class="px-3 py-1.5 rounded-lg bg-blue-600 text-white text-xs sm:text-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-200">
                                Terapkan
                            </button>
                        </div>
                    </div>
            ...
            <input type="hidden" name="per_page" id="perPageInput" value="{{ $filters['per_page'] ?? 10 }}">
            ...
            <div class="relative md:ml-auto">
                <button type="button" id="pageSizeBtn"
                    ...
                    <span>
                        Baris:
                        <strong id="pageSizeLabel" class="font-semibold text-neutral-800">
                            {{ $filters['per_page'] ?? 10 }}
                        </strong>
                    </span>
                ...
                <div id="pageSizeMenu"
                    ...
                    @foreach ([10, 20, 50] as $pp)
                        <button type="button" role="menuitemradio"
                            class="page-size-item w-full text-left rounded-xl px-3 py-2 text-sm"
                            data-size="{{ $pp }}">
                            {{ $pp }} per halaman
                        </button>
                    @endforeach
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ $hasPrev ? $url($current - 1) : '#' }}"
                    class="min-w-9 h-9 px-3 flex items-center justify-center rounded-2xl border text-sm
                          {{ $hasPrev
