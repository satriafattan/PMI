...
@section('content')
    <div class="min-h-screen bg-white text-slate-800">
        ...
        <section class="py-10 sm:py-14">
            <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                            ...
                            <div class="grid gap-5 sm:grid-cols-2">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-slate-700">Nomor Registrasi <span
                                            class="text-red-600">*</span></label>
                                    <input type="text" required name="no_regis_rs" value="{{ old('no_regis_rs') }}"
                                        class="{{ $field }}" placeholder="Masukkan nomor registrasi">
                                    @error('no_regis_rs')
                                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nama_suami_istri" value="{{ old('nama_suami_istri') }}"
                                        class="{{ $field }}" placeholder="(Opsional)">
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-slate-700">Nama Dokter <span
                                            class="text-red-600">*</span></label>
                                    <input type="text" required name="nama_dokter" value="{{ old('nama_dokter') }}"
                                        class="{{ $field }}" placeholder="Nama dokter penanggung jawab">
                                    @error('nama_dokter')
                                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-slate-700">Nama Pasien <span
                                            class="text-red-600">*</span></label>
                                    <input type="text" required name="nama_pasien" value="{{ old('nama_pasien') }}"
                                        class="{{ $field }}" placeholder="Nama lengkap pasien">
                                    @error('nama_pasien')
                                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="grid gap-5 sm:grid-cols-2">
                                    <div class="relative sm:col-span-1">
                                        <div>
                                            ...
                                            <input type="date" name="tanggal_diperlukan"
                                                value="{{ old('tanggal_diperlukan') }}" required
                                                class="{{ $field }}">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-slate-700">Diagnosa Klinik <span
                                                class="text-red-600">*</span></label>
                                        <input type="text" name="diagnosa_klinik"
                                            value="{{ old('diagnosa_klinik') }}" required class="{{ $field }}"
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-slate-700">Tanggal Transfusi <span
                                                class="text-red-600">*</span></label>
                                        <input type="date" name="tanggal_transfusi"
                                            value="{{ old('tanggal_transfusi') }}" required class="{{ $field }}">
                                    </div>

                                    <div>
                                        <label class="block text-sm font-medium text-slate-700">Tanggal serologi <span
                                                class="text-red-600">*</span></label>
                                        <input type="date" name="tanggal_serologi"
                                            value="{{ old('tanggal_serologi') }}" required class="{{ $field }}">
                                    </div>
                                ...
                                <div class="space-y-5">
                                    <div class="relative">
                                        ...
                                        <select name="jumlah_kehamilan" class="{{ $select }}">
                                            ...
                                            @for ($i = 0; $i <= 8; $i++)
                                                <option value="{{ $i }}" @selected(old('jumlah_kehamilan') == $i)>
                                                    {{ $i }}</option>
                                            @endfor
                                        </select>
                                        <span class="pointer-events-none absolute bottom-3 right-3 text-slate-400">▾</span>
                                ...
                                <div>
                                    <div class="relative mt-2">
                                        <label class="block text-sm font-medium text-slate-700">Produk <span
                                                class="text-red-600">*</span></label>
                                        <select name="produk" required class="{{ $select }}">
                                            <option value="" disabled selected>Pilih produk darah</option>
                                            <option value="WB" @selected(old('produk') === 'WB')>WB: Whole Blood</option>
                                            <option value="PRC" @selected(old('produk') === 'PRC')>PRC: Packed Red Cell
                                            </option>
                                            <option value="TC" @selected(old('produk') === 'TC')>TC: Trombocyte Concentrate
                                            </option>
                                            <option value="FFP" @selected(old('produk') === 'FFP')>FFP: Fresh Frozen Plasma
                                            </option>
                                            <option value="AHF" @selected(old('produk') === 'AHF')>AHF: Cryoprecipitated AHF
                                            </option>
                                            <option value="LP" @selected(old('produk') === 'LP')>LP: Liquid Plasma</option>
                                            <option value="TCA" @selected(old('produk') === 'TCA')>TC Aferesis</option>
                                            <option value="PK" @selected(old('produk') === 'PK')>Plasma Konvalesen</option>
                                        </select>
                                        <span class="pointer-events-none absolute bottom-3 right-3 text-slate-400">▾</span>
                                    </div>
                                    @error('produk')
                                ...
                                <div class="mt-6 grid gap-5 sm:grid-cols-2">
                                    <div class="relative">
                                        <label class="block text-sm font-medium text-slate-700">Golongan Darah <span
                                                class="text-red-600">*</span></label>
                                        <select name="gol_darah" required class="{{ $select }}">
                                            <option value="" disabled selected>Pilih golongan darah</option>
                                            @foreach (['A', 'B', 'AB', 'O'] as $g)
                                                <option value="{{ $g }}" @selected(old('gol_darah') === $g)>
                                                    {{ $g }}</option>
                                            @endforeach
                                        </select>
                                        <span class="pointer-events-none absolute bottom-3 right-3 text-slate-400">▾</span>
                                    ...
                                    <div class="relative">
                                        <label class="block text-sm font-medium text-slate-700">Rhesus <span
                                                class="text-red-600">*</span></label>
                                        <select name="rhesus" required class="{{ $select }}">
                                            <option value="" disabled selected>Pilih rhesus</option>
                                            @foreach (['Rh+', 'Rh-'] as $r)
                                                <option value="{{ $r }}" @selected(old('rhesus') === $r)>
                                                    {{ $r }}</option>
                                            @endforeach
                                        </select>
                                        <span class="pointer-events-none absolute bottom-3 right-3 text-slate-400">▾</span>
                                    ...
                                    <div class="mt-2 space-y-3">
                                        @foreach (['Plasma Biasa', 'FFP (Fresh Frozen Plasma)'] as $a)
                                            <label class="flex items-center gap-2">
                                                <input type="checkbox" name="alasan_multi[]" value="{{ $a }}"
                                                    class="{{ $check }}"
                                ...
                                <div>
                                    ...
                                    <dl class="space-y-2 text-sm">
                                        <div class="flex">
                                            ...
                                            <dd id="cf_tgl_diperlukan" class="font-medium"></dd>
                                        </div>
                                        <div class="flex">
                                            <dt class="w-40 text-slate-500">Pernah Serologi</dt>
                                            <dd id="cf_pernah_serologi" class="font-medium"></dd>
                                        </div>
                                        <div class="flex">
                                            <dt class="w-40 text-slate-500">Diagnosa</dt>
                                            <dd id="cf_diagnosa_klinik" class="font-medium"></dd>
                                        </div>
                                        <div class="flex">
                                            <dt class="w-40 text-slate-500">Lokasi Serologi</dt>
                                            <dd id="cf_lokasi_serologi" class="font-medium"></dd>
                                        </div>
                                        <div class="flex">
                                            <dt class="w-40 text-slate-500">Tgl Serologi</dt>
                                            <dd id="cf_tgl_serologi" class="font-medium"></dd>
                                        </div>
                                        <div class="flex">
                                            <dt class="w-40 text-slate-500">Alasan Transfusi</dt>
                                            <dd id="cf_alasan_transfusi" class="font-medium"></dd>
                                        </div>
                                        <div class="flex">
                                            <dt class="w-40 text-slate-500">Hasil Serologi</dt>
                                            <dd id="cf_hasil_serologi" class="font-medium"></dd>
                                        </div>
                                    </dl>
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <dl class="space-y-2 text-sm">
                                        <div class="flex">
                                            ...
                                            <dd id="cf_jenis_darah" class="font-medium"></dd>
                                        </div>
                                        <div class="flex">
                                            <dt class="w-40 text-slate-500">Golongan Darah</dt>
                                            <dd id="cf_gol_darah" class="font-medium"></dd>
                                        </div>
                                        <div class="flex">
                                            <dt class="w-40 text-slate-500">Rhesus</dt>
                                            <dd id="cf_rhesus" class="font-medium"></dd>
                                        </div>
                                        <div class="flex">
                                            <dt class="w-40 text-slate-500">Jumlah Kantong</dt>
                                            <dd id="cf_jumlah_kantong" class="font-medium"></dd>
                                        </div>
                                        <div class="flex">
                                            <dt class="w-40 text-slate-500">Alasan Tambahan</dt>
                                            <dd id="cf_alasan_tambahan" class="font-medium"></dd>
                                        </div>
                                    </dl>
                                </div>
                            </div>
                ...
                {{-- Success Modal --}}
                <div id="successModal" class="fixed inset-0 z-[9999] hidden items-center justify-center">
                    <div class="absolute inset-0 bg-black/40"></div>

                    <div class="relative z-10 w-[90%] max-w-2xl rounded-3xl bg-white p-10 text-center shadow-2xl">
                        <button type="button" class="absolute right-4 top-4 text-2xl text-slate-400 hover:text-slate-600"
                        ...
                        <!-- GANTI JUDUL DI SINI -->
                        <h3 id="successTitle" class="text-2xl font-bold text-slate-800">
                            Pengajuan Berhasil Dikirim!
                        </h3>

                        <!-- GANTI PESAN DI SINI -->
                        <p id="successMessage" class="mt-3 text-lg text-slate-600">
    ...
    <script>
        ...
        function openConfirmModal() {
            ...
            setCF('cf_jenis_darah', produkMap[produkKode] || '');
            const golDarahVal = val('gol_darah');
            const rhesusVal = val('rhesus');
            setCF('cf_gol_darah', golDarahVal);
            setCF('cf_rhesus', rhesusVal);
