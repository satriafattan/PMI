...
@section('content')
                        ...
                        <div class="step hidden" id="step-4">
                            <div class="mx-auto max-w-3xl rounded-2xl border border-slate-200 p-5 md:p-6">
                                ...
                                <div class="mt-6">
                                    ...
                                    <input type="text" name="alasan_tambahan" value="{{ old('alasan_tambahan') }}"
                                        class="{{ $field }}" placeholder="(Opsional) Alasan tambahan singkat">
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <dl class="space-y-2 text-sm">
                                        ...
                                        <div class="flex">
                                            ...
                                            <dd id="cf_tanggal_serologi" class="font-medium"></dd>
                                        </div>
                                        <div class="flex">
    ...
    <script>
        ...
        function openConfirmModal() {
            ...
            const tglDiperlukan = val('tanggal_diperlukan');
            const tglSerologi = val('tanggal_serologi');
            ...
            setCF('cf_tanggal_serologi', tglSerologi);
            ...
            setCF('cf_alasan_tambahan', val('alasan_tambahan')); // input text
