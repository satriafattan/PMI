                                    ...
                                    <div class="relative sm:col-span-1">
                                        <div>
                                            ...
                                            <input type="date" name="tanggal_transfusi"
                                                value="{{ old('tanggal_transfusi') }}" required
                                                class="{{ $field }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-2 space-y-3">
                                        @foreach (['Segar', 'Biasa', 'Cuci'] as $j)
                                            <label class="flex items-center gap-2">
                                                <input type="checkbox" name="produk_multi[]" value="{{ $j }}"
                                                    class="{{ $check }}" onclick="selectSingleJenisDarah(this)">
                                                <span>{{ $j }}</span>
                                            </label>
                                        @endforeach
                                    </div>
                ...
                @if (session('success'))
                    <div id="successModal" class="fixed inset-0 z-[10000] hidden items-center justify-center">
                        ...
                        <div class="relative z-10 w-[92%] max-w-md rounded-2xl bg-white p-6 shadow-xl">
                            <div
                                class="mx-auto mb-3 grid h-12 w-12 place-items-center rounded-full bg-emerald-100 text-emerald-700">
                                ✓
                            </div>
