...
<body style="margin:0;padding:0;font-family:'Times New Roman',Times,serif;background-color:#f5f5f5;">
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#f5f5f5;padding:30px 0;">
    <tr>
      <td align="center">
        <table width="650" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff;box-shadow:0 2px 8px rgba(0,0,0,.1);">
          <!-- Kop Surat -->
          <tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="width:72px;vertical-align:top;">
                    <img src="{{ asset('images/pmi-logo.png') }}" alt="PMI" width="56" height="56" style="display:block;border:0;">
                  </td>
                  <td style="text-align:left;">
                    <h2 style="color:#dc2626;margin:0 0 4px 0;font-size:20px;font-weight:bold;letter-spacing:.5px;">PALANG MERAH INDONESIA</h2>
                    <h3 style="color:#1f2937;margin:0 0 6px 0;font-size:18px;font-weight:bold;">UNIT DONOR DARAH PROVINSI LAMPUNG</h3>
          ...
          <tr>
            <td style="padding:0 40px 20px 40px;">
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="center">
                    <table cellpadding="0" cellspacing="0" border="0" style="background:{{ $config['bg'] }};border:2px solid {{ $config['color'] }};">
                      <tr>
                        <td style="padding:12px 40px;text-align:center;">
                          <strong style="color:{{ $config['color'] }};font-size:15px;letter-spacing:1px;">STATUS: {{ $config['label'] }}</strong>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td style="padding:0 40px 20px 40px;">
              <table width="100%" cellpadding="10" cellspacing="0" border="1" style="border-collapse:collapse;border:1px solid #d1d5db;">
                ...
                <tr>
                  <td style="border:1px solid #d1d5db;padding:10px;width:40%;color:#374151;font-size:13px;">Nomor Pemesanan</td>
                  <td style="border:1px solid #d1d5db;padding:10px;color:#1f2937;font-size:13px;"><strong>#{{ $pemesanan->id ?? 'N/A' }}</strong></td>
                </tr>
                <tr style="background:#f9fafb;">
                  <td style="border:1px solid #d1d5db;padding:10px;color:#374151;font-size:13px;">Produk Darah</td>
                  <td style="border:1px solid #d1d5db;padding:10px;color:#1f2937;font-size:13px;">{{ $produk }}</td>
                </tr>
                <tr>
                  <td style="border:1px solid #d1d5db;padding:10px;color:#374151;font-size:13px;">Golongan Darah</td>
                  <td style="border:1px solid #d1d5db;padding:10px;color:#1f2937;font-size:13px;"><strong>{{ $gol }}{{ $rhesus ? ' ' . $rhesus : '' }}</strong></td>
                </tr>
                <tr style="background:#f9fafb;">
                  <td style="border:1px solid #d1d5db;padding:10px;color:#374151;font-size:13px;">Jumlah Kantong</td>
                  <td style="border:1px solid #d1d5db;padding:10px;color:#1f2937;font-size:13px;">{{ $jumlah }} Kantong</td>
                </tr>
                <tr>
                  <td style="border:1px solid #d1d5db;padding:10px;color:#374151;font-size:13px;">Rumah Sakit Pemesan</td>
                  <td style="border:1px solid #d1d5db;padding:10px;color:#1f2937;font-size:13px;">{{ $rsPemesan }}</td>
                </tr>
              </table>
            </td>
          </tr>
            ...
            <td style="padding:0 40px 20px 40px;">
              @if ($statusKey === 'approved')
                ...
                <p style="margin:0;font-size:13px;color:#374151;line-height:1.8;text-align:justify;">
                  Dimohon untuk melakukan <strong>pengambilan darah paling lambat 2 × 24 jam</strong> sejak surat elektronik ini diterbitkan.
                  Apabila terdapat kendala, silakan menghubungi petugas Unit Donor Darah.
                </p>
              @elseif ($statusKey === 'rejected')
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#fef2f2;border-left:4px solid #dc2626;">
                  <tr>
                    <td style="padding:15px;">
                      <p style="margin:0 0 8px 0;font-size:13px;color:#374151;line-height:1.8;text-align:justify;">
                        Berdasarkan verifikasi, permohonan pemesanan darah Bapak/Ibu <strong>BELUM DAPAT DIPENUHI</strong> saat ini,
              ...
              @else
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#fffbeb;border-left:4px solid #d97706;">
                  <tr>
                    <td style="padding:15px;">
                      <p style="margin:0;font-size:13px;color:#374151;line-height:1.8;text-align:justify;">
                        Permohonan Bapak/Ibu saat ini <strong>MENUNGGU VERIFIKASI</strong>. Kami akan menghubungi kembali setelah proses selesai.
                      </p>
                    </td>
                  </tr>
                </table>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td style="width:50%;text-align:center;">
                    ...
                    <p style="margin:0 0 14px 0;font-size:13px;color:#374151;font-weight:bold;">Unit Donor Darah PMI Provinsi Lampung</p>

                    <!-- Cap PNG transparan (email aman) -->
                    <img src="{{ asset('images/cap-pmi.png') }}" alt="Cap PMI" width="120" style="display:block;margin:0 auto 28px auto;border:0;">

                    <!-- Nama Jabatan -->
                    <p style="margin:0;font-size:13px;color:#374151;border-bottom:1px solid #374151;display:inline-block;padding-bottom:2px;">
